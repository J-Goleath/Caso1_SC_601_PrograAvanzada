...
{
    public class EditarPrioridadValidator : AbstractValidator<EditarPrioridadDto>
    {
        public EditarPrioridadValidator()
        {
            RuleFor(r => r.Id)
                .NotEmpty().WithMessage("El ID de la prioridad es obligatorio.")
                .GreaterThan(0).WithMessage("El ID de la prioridad debe ser un numero positivo.");
